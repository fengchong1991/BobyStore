...
namespace BabyStore.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            {
                viewModel.ImageLists.Add(new SelectList(db.ProductImgaes, "ID", "FileName"));
            }
        ...
        public ActionResult Create(ProductViewModel viewModel)
        {
            ...
            for (int i = 0; i < productImages.Length; i++)
            {
                ...
                {
                    ProductImage = db.ProductImgaes.Find(int.Parse(productImages[i])),
                    ImageNumber = i
                });
            }
            ...
            for (int i = 0; i < Constants.NumberOfProductImages; i++)
            {
                viewModel.ImageLists.Add(new SelectList(db.ProductImgaes, "ID", "FileName", viewModel.ProductImages[i]));
            }
            return View(viewModel);
        }
